...
.ratings .ratingselect .switch .icon-check_circle {
  display: inline-block;
  vertical-align: top;
  margin-right: 4px;
  font-size: 24px
...
.ratings .rating-wrapper .rating-item {
  display: flex;
  padding: 18px 0rgba(7, 17, 27, 0.1)
}
...
.ratings .icon-remove_circle_outline {
  display: inline-block;
  padding: 6px;
  line-height: 24px;
  font-size: 24px;
...
.ratings .icon-remove_circle_outline.move-enter-active,
.ratings .icon-remove_circle_outline.move-leave-active {
  transition: all .3s
}

.ratings .icon-remove_circle_outline.move-enter,
.ratings .icon-remove_circle_outline.move-leave-to {
  opacity: 0;
